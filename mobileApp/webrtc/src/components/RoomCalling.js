...
class RoomCalling extends React.Component {
  constructor(props) {
    super(props)
    ...
    this.serviceIP = 'http://192.168.1.6:8082/webrtcPeer'
  ...
  componentDidMount = () => {
    if (this.props.IdRoom) {
      this.joinRoom(this.props.IdRoom)
    }
  }
